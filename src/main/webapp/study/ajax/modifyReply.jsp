...
<body>
	...
	<div id="reply" class="panel panel-info">
		<div id="replylist" class="panel-heading">
			<button class="btn btn-primary">댓 글 조 회</button>
		</div>
...
// 		pageMaker.prev = true;
		if(pageMaker.prev)
			str +='<li><a href="#"  data-num="' + (pageMaker.startPage - 1) + '">' + "go</a></li>";	
...
// 		pageMaker.next = true;
		if(pageMaker.next)
			str +='<li><a href="#" data-num="' + (pageMaker.endPage + 1) +'">' + " back</a></li>";
