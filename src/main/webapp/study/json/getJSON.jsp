...
<h2>이기종 간에 (ex:서버와 클라이언트) 데이터 통신방법</h2>
<ol>
...
<h1>AJAX</h1>
<h3> (Asynchronous JavaScript and XML : 비동기 자바스크립트 데이터 통신 기술)</h3>
...
<ul id="result" class="list-group-item-success"> </ul>
...
<script type="text/javascript">
	...
	$('button').eq(1).on('click', function () {
		$.getJSON("/study/json/depts.json", function(data) {
			...
			var lis="";
			for(var i=0; i<data.length; i++) {
				lis += '<li class="list-group-item-success">' + data[i].deptno + ", " + data[i].dname + ", " + data[i].loc + "</li>";
			}
