...
//		b.setBno(10); b.setContent("xxxxx"); b.setTitle("yyyyy"); 
//		boards.add(b);
	...
	public ResponseEntity<String> listAll(Criteria cri, HttpServletResponse response) {
		logger.info(cri.toString());
		response.setContentType("application/json");
		
		return new ResponseEntity<String>("SUCCESSSS", HttpStatus.OK);
	}
}
